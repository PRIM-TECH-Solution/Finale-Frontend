...
import DetailsMainCardTcategory from "../components/DetailsMainCardTcategory";
  ...
  return (
    <div className="book-tickets-for-event" data-animate-on-scroll>
      ...
      <Stepper
        ...
        bGBackgroundColor1="rgba(30, 30, 30, 0.5)"
        doneColor="rgba(30, 30, 30, 0.5)"
      />
